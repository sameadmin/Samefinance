...
contract StrategyDeposit_MDX is Ownable, ReentrancyGuard, Strategy {
    ...
    nonReentrant
    {
        address token0 = MDEXGoblin(msg.sender).token0();
        address token1 = MDEXGoblin(msg.sender).token1();
        uint256 minLPAmount;
        {
